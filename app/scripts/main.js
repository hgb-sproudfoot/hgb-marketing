...
function startAnim() {
    ...
    masterTimeline.to('#typer', 1, {viewBox: '100 0 600 600'});
    ...
    masterTimeline.to('#itinerary-3 #Rounded-Rectangle', 0.25, { filter: 'url(#inset-shadow)', fill: '#3F7F9A', ease: Power1.easeIn });
    ...
    masterTimeline.to('#itinerary-2 #Rounded-Rectangle', 0.25, { filter: 'url(#inset-shadow)', fill: '#3F7F9A', ease: Power1.easeIn });
    masterTimeline.to('#itinerary-2 #Rounded-Rectangle', 0.25, { filter: 'url(#dropshadow)', fill: '#4C8CA7', ease: Power1.easeOut }, 'buttonPressed');
    ...
    masterTimeline.to('#itinerary-1 #Rounded-Rectangle', 0.25, { filter: 'url(#inset-shadow)', fill: '#3F7F9A', ease: Power1.easeIn });
